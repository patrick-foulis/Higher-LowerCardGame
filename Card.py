...
class Card(): 
    ...
    def _init_(self, window, rank, suit, value):
        self.window = window
        self.rank = rank 
        self.suit = suit
        ...
        self.images = ipywidgets.ImageCollection(window, (0, 0), 
                                                {'front': fileName, 
    ...
    def getRank(self):
        return self.rank
    def setLock(self,loc): #call the setLoc method of the ImageCollection
        self.images.setLoc(loc)
    def getLoc(self): #get the location from ImageCollection 
